...
QT_MOC_LITERAL(1, 6, 19), // "signalTimerAdvanced"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 16), // "startMasterTimer"
QT_MOC_LITERAL(4, 44, 15), // "stopMasterTimer"
QT_MOC_LITERAL(5, 60, 10), // "resetTimer"
QT_MOC_LITERAL(6, 71, 12) // "advanceTimer"

    },
    "Timer\0signalTimerAdvanced\0\0startMasterTimer\0"
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalTimerAdvanced((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Timer::signalTimerAdvanced)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Timer::signalTimerAdvanced(int _t1)
{
